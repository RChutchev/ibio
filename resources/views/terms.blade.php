...
@section('page-title')
    {{ __("Terms of Use | ") . config('app.name') }}
@endsection
...
@section('content')
    <div class="container w-full py-20 px-5 mx-auto px-5" style="min-height: calc(100vh - 134px)">
        <div class="prose-xl">
            ...
            <p>Registering in {{ config('app.name') }} means that you have accepted all of the terms of conditions.</p>
            <h2>Account</h2>
            <p>{{ config('app.name') }} is FREE and everyone is allowed to create their account.</p>
            ...
            <h2>Content</h2>
            <p>Everything you post on {{ config('app.name') }} including links, texts, videos and music tracks are considered as content.</p>
            <p>You can use {{ config('app.name') }} to post your content if:</p>
            <ul>
