...
class Urls extends Model
{
    ...
    protected $appends = ['uniqueClicks'];

    public function getUniqueClicksAttribute()
    {
        $self = self::find($this->id);
        $total = $self->visits()
    ...
    */
    ...
    {
        return $this->hasMany(Visit::class, 'url_id');
    }
    ...
    */
    ...
    public function getKeyword($destination): string
    {
        $keyGen = app(KeyGeneratorService::class);

        return $keyGen->generate($destination);
    }
